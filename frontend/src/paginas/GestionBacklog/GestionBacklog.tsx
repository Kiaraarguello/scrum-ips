          ...
          {proyectos.map((p) => (
            <div key={p.id} className="gestion-backlog__tarjeta">
              ...
              {p.usuarios && p.usuarios.length > 0 && (
                <div className="gestion-backlog__tarjeta-miembros">
                  <span className="gestion-backlog__tarjeta-miembros-label">Miembros</span>
                  <div className="gestion-backlog__tarjeta-miembros-avatares">
                    {p.usuarios.map((u) => (
                      <div
                        key={u.id}
                        className="gestion-backlog__tarjeta-miembro-avatar"
                  ...
                  <span className="gestion-backlog__tarjeta-miembros-count">
                    {p.usuarios.length} {p.usuarios.length === 1 ? 'persona' : 'personas'}
                  </span>
                </div>
              )}
